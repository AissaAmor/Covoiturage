    ...
    for (let i = 0; i < mytable.length; i++) {
        ...
        <p class="from-day">
                    ...
                    <div class="text p-4 text-center"style="width: 100%;">
                        ...
                        <p class="d-flex mb-0 d-block"><a href="#" class="btn btn-black btn-outline-black mr-1"style="width:350px;">Annuler</a>                          
                        </div>
                        </div>
                        </div>`
        }
    ...
    for (let i = 0; i < reserver.length; i++) {
        ...
        <p class="from-day">
                    ...
                    <div class="text p-4 text-center"style="width: 100%;">
                        ...
                        <h6 class="mb-0"><a >date de trajet</a>:<span  style="color:rgb(255, 0, 0)" id="ddt"> ${reserver[i]['arriveTrajet']} </span> </h6>
                        <p class="d-flex mb-0 d-block"><a onclick="annuleReservation(${i},${mytable[i].id})" class="btn btn-black btn-outline-black mr-1"style="width:350px;">Annuler</a>                          
                        </div>
                        </div>
                        </div>`
        }
...
function annuleReservation(pos, idAnnonce) {
    var mytable = JSON.parse(localStorage.getItem('table'));
    var reserver = JSON.parse(localStorage.getItem('Reservation'));
    // var connectedUser = JSON.parse(localStorage.getItem('loggedUser'));
    console.log(pos);
    ...
    for (let i = 0; i < reserver.length; i++) {
        if (reserver[i].id == mytable[pos].id) {
            reserver.splice(i, 1);
            localStorage.setItem('Reservation', JSON.stringify(reserver));
            localStorage.setItem('table', JSON.stringify(mytable));
            mytable[pos].place++;
                ...
                <div class="car-wrap">
                    ...
                    <div class="text p-4 text-center" style="width: 100%;">
                        ...
                        <h6 class="mb-0"><a >lieux d'arrivée </a>:<span  style="color:rgb(255, 0, 0)" id="lda"> ${mytable[i].arriveTrajet}</span> </h6>
                           ...
                           <p class="d-flex mb-0 d-block"><a onclick="reservation(${i})" class="btn btn-black btn-outline-black mr-1"style="width:200px;">Réserver</a>
                    </div>
                            ...
                            <div class="car-wrap ftco-animate">
                                ...
                                <div class="text p-4 text-center">
                                    ...
                                    <h6 class="mb-0"><a >lieux d'arrivée </a>:<span  style="color:rgb(255, 0, 0)" id="lda"> ${mytable[i].arriveTrajet}</span> </h6>
                                       ...
                                       <p class="d-flex mb-0 d-block"><a onclick="reservation(${i})" class="btn btn-black btn-outline-black mr-1"style="width:200px;">Réserver</a>                                                                              </div>
